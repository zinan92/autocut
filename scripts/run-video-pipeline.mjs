...
const sourceVideo = resolve(dirname(manifestPath), manifest.sourceVideo);
...
const ingest = probeMedia(sourceVideo);
...
const steps = [
  { step: "ingest", status: "done", output: join(sessionDir, "ingest.json") },
];
